    ...
    properties: {
      ...
      data: {
        ...
        properties: {
          ...
          available_power_hp: { type: 'number', format: 'float', example: 42.8, description: 'Potencia neta disponible en la barra de tiro (ruta Zoz)' },
          pto_available_power_hp: { type: 'number', format: 'float', example: 57.6, description: 'Potencia disponible en la TDF (bruta × eficiencia Fig. 47)' },
          margin_hp: { type: 'number', format: 'float', example: -39.33, description: 'Diferencia disponible − requerida (según power_kind)' },
    ...
    properties: {
      ...
      data: {
        ...
        properties: {
          ...
          available_power_hp: { type: 'number', format: 'float', example: 42.8, description: 'Potencia neta en la barra de tiro (ruta Zoz)' },
          pto_available_power_hp: { type: 'number', format: 'float', example: 57.6, description: 'Potencia disponible en la TDF' },
          margin_hp: { type: 'number', format: 'float', example: -39.33 },
