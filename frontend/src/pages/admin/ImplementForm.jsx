...
import { withImageUrl } from '@/lib/imagePayload';
...
const ImplementCRUD = () => {
  ...
  const obtenerPayload = () => {
    ...
    payload = withImageUrl(payload, implementoActual.imageUrl);
  ...
  const handleEliminarImagen = async () => {
    if (!implementoActual.imageUrl || eliminandoImagen) return;

    setEliminandoImagen(true);
    try {
      await deleteImage(implementoActual.imageUrl);
      setImplementoActual((prev) => ({ ...prev, imageUrl: null }));
