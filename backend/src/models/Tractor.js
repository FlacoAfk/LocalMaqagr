...
class Tractor {
  ...
  static async update(id, tractorData) {
    const imageUrlProvided = Object.prototype.hasOwnProperty.call(tractorData || {}, 'image_url')
      && tractorData.image_url !== undefined;
    const {
      name,
      brand,
      model,
    ...
    const query = `
      ...
      SET name = COALESCE($1, name),
          ...
          image_url = CASE WHEN $20 THEN $4 ELSE image_url END,
