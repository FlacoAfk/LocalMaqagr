...
// Cargar .env manualmente. En instalaciones (Program Files) el archivo no
// existe por diseño: el launcher inyecta las variables de entorno en runtime.
// Silenciar el caso esperado para no contaminar la salida.
const result = existsSync(envPath) ? dotenv.config({ path: envPath, quiet: true }) : null;
...
// Local development: no SSL by default
...
export const pool = new Pool({
  ...
  database: process.env.DB_NAME || 'maqagr_local',
